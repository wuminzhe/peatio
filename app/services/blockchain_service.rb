class BlockchainService
  ...
  def update_or_create_deposit(transaction)
    ...
    # Manually calculationg deposit confirmations, because blockchain height is not updated yet.
  ...
  def update_withdrawal(transaction)
    ...
    # Manually calculationg withdrawal confirmations, because blockchain height is not updated yet.
